...
public class Cadastro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(editarGasto != null){
            btn_Cadastrar.setText(R.string.modificar);
            ...
            btn_Cadastrar.setText(R.string.cadastrar);
        }
        ...
        btn_Cadastrar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(editText_Valor.getText().toString().trim().equals("")){
                    ...
                    Intent e = new Intent(Cadastro.this, MainActivity.class);
                    startActivity(e);
                }
